...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "E:\\Dev\\NODE\\My Work\\prabandh",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"util.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loaderDisplay = exports.showAlert = void 0;
...
var showAlert = function showAlert(msg, type) {
  hideAlert();
  var html = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
exports.loaderDisplay = loaderDisplay;
...
exports.login = exports.renderLoginInput = void 0;
...
var renderLoginInput = function renderLoginInput(el) {
...
exports.renderLoginInput = renderLoginInput;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (res.data.success === 'success') {
              (0, _util.showAlert)('Logged in successfully', 'success');
          ...
          case 11:
            ...
            (0, _util.showAlert)(_context.t0.response.data.message, 'error');
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./util":"util.js"}],"menuUtility.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getAllMenu = exports.getMenuByCategory = void 0;
...
var getMenuByCategory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(category) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "/api/v1/menu/".concat(category); //const url = `/api/v1/menu/${category}`;
          ...
          case 4:
            ...
            return _context.abrupt("return", res.data.data.menuCategory);
          ...
          case 11:
            ...
            (0, _util.showAlert)('Error while retrieving menu', 'error');
  ...
  return function getMenuByCategory(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var getAllMenu = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = "/api/v1/menu/all"; //const url = `/api/v1/menu/${category}`;
          ...
          case 4:
            ...
            return _context2.abrupt("return", res.data.data.menu);
  ...
  return function getAllMenu() {
    return _ref2.apply(this, arguments);
  };
}();

exports.getAllMenu = getAllMenu;
},{"axios":"../../node_modules/axios/index.js","./util":"util.js"}],"updateMenu.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addMenu = exports.updateMenuAction = exports.updateMenuSelection = exports.updateMenuModalDisplay = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _menuUtility = require("./menuUtility");
...
var updateMenuModalDisplay = function updateMenuModalDisplay() {
  document.getElementById('um-modal-wrapper').classList.toggle('um-modal-hide');
};

exports.updateMenuModalDisplay = updateMenuModalDisplay;

var updateMenuSelection = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(category) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _menuUtility.getMenuByCategory)(category);

          case 3:
            data = _context.sent;
            menuContainer = document.querySelector('.um-menus');
            html = data.map(function (el) {
              return "\n      <div class=\"items\" data-id = \"".concat(el._id, "\">\n              <input\n                type=\"text\"\n                name=\"menu-item-name\"\n                id=\"menu-item-name\"\n                class=\"item-name\"\n                value=\"").concat(el.item, "\"\n              />\n    \n              <input\n                type=\"number\"\n                name=\"menu-item-price\"\n                id=\"menu-item-price\"\n                class=\"item-price\"\n                value=\"").concat(el.price, "\"\n              />\n    \n              <input\n                type=\"number\"\n                name=\"menu-item-qty\"\n                id=\"menu-item-qty\"\n                class=\"item-qty\"\n                value=\"").concat(el.qty, "\"\n              />\n    \n               <i class=\"fas fa-save fa-3x um-save\" ></i>\n              <i class=\"fas fa-trash-alt fa-2x um-delete\"></i>\n            </div>\n      ");
            }).join('');
  ...
  return function updateMenuSelection(_x) {
    return _ref.apply(this, arguments);
  };
}(); //Save New Menu


exports.updateMenuSelection = updateMenuSelection;

var addMenu = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var item, price, qty, category, url, data, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            item = document.getElementById('modal-item-name').value;
            price = document.getElementById('modal-item-price').value;
            qty = document.getElementById('modal-item-qty').value;
            category = document.getElementById('um-select').value;
          ...
          case 18:
            ...
            (0, _util.loaderDisplay)();
            showAlert(_context2.t0.response.data.message, 'error');
...
var updateSaveMenu = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            (0, _util.loaderDisplay)();
            showAlert(_context3.t0.response.data.message, 'error');
  ...
  return function updateSaveMenu(_x2, _x3) {
...
var deleteMenu = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id, item) {
    var url, category, res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            if (!confirm("Do you want to delete the menu ".concat(item))) {
              _context4.next = 15;
              break;
            }

            (0, _util.loaderDisplay)();
            url = "/api/v1/menu/delete/".concat(id);
            category = document.getElementById('um-select').value;
            _context4.prev = 4;
            _context4.next = 7;
            return (0, _axios.default)({
          ...
          case 11:
            ...
            showAlert(_context4.t0.response.data.message, 'error');
  ...
  return function deleteMenu(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();

var updateMenuAction = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
    var parentElem, currElem, id, item, price, qty;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            item = parentElem.querySelector('#menu-item-name').value;
            ...
            price = parentElem.querySelector('#menu-item-price').value;
            qty = parentElem.querySelector('#menu-item-qty').value;
            updateSaveMenu(id, {
              item: item,
              price: price,
              qty: qty
          ...
          case 11:
            if (!currElem.classList.contains('um-delete')) {
              _context5.next = 15;
              break;
            }
  ...
  return function updateMenuAction(_x6) {
    return _ref5.apply(this, arguments);
  };
}();

exports.updateMenuAction = updateMenuAction;
},{"axios":"../../node_modules/axios/index.js","./menuUtility":"menuUtility.js","./util":"util.js"}],"../../node_modules/dom-to-image/src/dom-to-image.js":[function(require,module,exports) {
var global = arguments[3];
(function (global) {
    'use strict';
...
},{}],"printMenu.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.printMenu = exports.renderMenu = void 0;
...
var getMenuItemMarkup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(category, index) {
    var data, html;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            data = _context.sent;
            html = data.map(function (el, i) {
              return "\n      ".concat(i === 0 ? "<h1>".concat(category, "</h1>") : '', "\n      <div class=\"pm-menu-info\">\n        <p>").concat(el.item).concat(el.qty > 0 ? "(".concat(el.qty, "pc)") : '', "</p>\n        <p>..........").concat(el.price, "</p>\n      </div>\n    \n      ");
            }).join('');
  ...
  return function getMenuItemMarkup(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

var renderMenu = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(categoryList) {
    var item1Container, item2Container, item3Container, arrCategory, item1, item2, item3;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            (0, _util.loaderDisplay)();
            item1Container = document.querySelector('.pm-menu-item-1');
            item2Container = document.querySelector('.pm-menu-item-2');
            item3Container = document.querySelector('.pm-menu-item-3');
            item1Container.innerHTML = '';
            item2Container.innerHTML = '';
            item3Container.innerHTML = '';
            arrCategory = categoryList.split(',');
            _context2.next = 10;
            return getMenuItemMarkup(arrCategory[0], 1);

          case 10:
            item1 = _context2.sent;
            _context2.next = 13;
            return getMenuItemMarkup(arrCategory[1], 2);

          case 13:
            item2 = _context2.sent;
            _context2.next = 16;
            return getMenuItemMarkup(arrCategory[2], 3);

          case 16:
            item3 = _context2.sent;
  ...
  return function renderMenu(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
},{"dom-to-image":"../../node_modules/dom-to-image/src/dom-to-image.js","./menuUtility":"menuUtility.js","./util":"util.js"}],"billMenu.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.billInit = void 0;
...
var renderSummary = function renderSummary(count, total) {
  var html = "<p>Selected Items : <span class=\"bill-selection-count\">".concat(count, "</span></p><p>Selected Price : <span class=\"bill-selection-price\">").concat(total, "</span></p>");
  var menuSummary = document.querySelector('.bill-selection-info__result');
  menuSummary.innerHTML = '';
  menuSummary.insertAdjacentHTML('afterbegin', html);
};

var renderBillMenu = function renderBillMenu() {
  var categoryData = workData.filter(function (el) {
    return el.category === curCategorySel;
  });
  var markup = categoryData.map(function (el) {
    return "\n        <div class=\"bill-menu-item__wrapper ".concat(el.isSelected ? 'menu-checked' : '', "\" data-id = ").concat(el._id, ">\n        <div class=\"bill-menu-item\" data-id = ").concat(el._id, ">\n          <input type=\"checkbox\" class=\"menu-select\" ").concat(el.isSelected ? 'checked' : '', "/>\n          <p class=\"bill-menu-item__title\">").concat(el.item, "</p>\n          <p class=\"bill-menu-item__qty\">").concat(el.qty, "</p>\n          <p class=\"bill-menu-item__amount\">").concat(el.price, "</p>\n      \n          <div class=\"inputQty_wrapper\">\n            <span>Pcs</span>\n      \n            <input\n              type=\"number\"\n              id=\"menu-item__inputQty\"\n              class=\"menu-item__inputQty\"\n              value = ").concat(el.inputQty, "\n              ").concat(!el.isSelected ? 'disabled' : '', "\n              ").concat(!el.qty ? 'disabled' : '', "\n            />\n          </div>\n      \n          <div class=\"inputPlate_wrapper\">\n            <span>Plt</span>\n            <input\n              type=\"number\"\n              id=\"menu-item__inputPlate\"\n              class=\"menu-item__inputPlate\"\n              value = ").concat(el.inputPlt, "\n              ").concat(!el.isSelected ? 'disabled' : '', "\n            />\n          </div>\n        </div>\n        <input\n          type=\"text\"\n          id=\"menu-item__total\"\n          class=\"menu-item__total\"\n          value=").concat(el.total, "\n          disabled=\"disabled\"\n        />\n      </div>\n        ");
  }).join('');
  var billMenuContainer = document.querySelector('.bill-menu-items');
  billMenuContainer.innerHTML = '';
  billMenuContainer.insertAdjacentHTML('afterbegin', markup);
};

var setMenuSelection = function setMenuSelection(id) {
  var count = 0;
  var total = 0;
...
var updatePrice = function updatePrice(value, attribute, id, totalInput) {
  var total = 0;
  var sCount = 0;
  var sTotal = 0;
  workData.forEach(function (el) {
...
var updateReviewPrice = function updateReviewPrice(e) {
  if (e.target.classList.contains('inputReviewAmt')) {
    ...
    var reviewAmount = document.querySelector('.reviewAmount');
    reviewAmount.innerHTML = "Rs ".concat(getTotal());
  }
};
...
var renderReview = function renderReview() {
  ...
  var reviewItems = document.querySelector('.bill-review-price-items');
  var reviewAmount = document.querySelector('.reviewAmount');
  reviewItems.innerHTML = '';
  var markup = selectionData.map(function (el) {
    return "\n          <div class=\"bill-review-price-item\">\n          <p class= ".concat(el.inputQty > 0 && el.inputPlt > 0 ? 'review-error' : '', ">").concat(el.item, " [").concat(el.price, "]</p>\n          <p class= ").concat(el.inputQty > 0 && el.inputPlt > 0 ? 'review-error' : '', ">").concat(el.inputQty, " Pieces</p>\n          <div class=\"bill-review-price \" data-id = ").concat(el._id, ">\n            <span>Rs</span><input type=\"number\" name=\"\" id=\"\" value=\"").concat(el.total, "\"  class = \"inputReviewAmt\"/>\n          </div>\n        </div>\n          ");
  }).join('');
  reviewItems.insertAdjacentHTML('afterbegin', markup);
  reviewAmount.innerHTML = getTotal();
};

var getCompliment = function getCompliment(e) {
  if (e.target.checked) {
    var comp = {
...
var getFinalReciept = function getFinalReciept() {
  var finalReceipt = document.querySelector('.bill-final-receipts');
  var html = selectionData.map(function (el) {
    return "\n          <div class=\"bill-final-receipt\">\n              <p class=".concat(el.total === 0 ? 'comp' : '', ">").concat(el.item, " </p>\n              <p>Rs ").concat(el.total, "</p>\n            </div>\n          ");
  }).join('');
  finalReceipt.innerHTML = '';
  finalReceipt.insertAdjacentHTML('afterbegin', html);
  document.querySelector('.bill-final-total').innerHTML = "Rs ".concat(getTotal());
};

var billInit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var data, billCategory, billMenuItems, reviewBtn, reviewPrevBtn, billCtaContainer, billReviewContainer, billReviewItems, complimentItems, reviewNextBtn, receiptContainer, recieptPrevBtn;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _util.loaderDisplay)();
            _context.next = 3;
            return (0, _menuUtility.getAllMenu)();
          ...
          case 3:
            ...
            (0, _util.loaderDisplay)(); //Add All Event Listener
            ...
            billMenuItems = document.querySelector('.bill-menu-items');
            ...
            billMenuItems.addEventListener('input', function (e) {
              if (e.target.classList.contains('menu-item__inputQty')) {
                var input = e.target.parentNode.parentNode.parentNode.querySelector('.menu-item__total');
                var parentElem = e.target.parentElement.parentElement;
                updatePrice(e.target.value, 'qty', parentElem.dataset.id, input);
              }

              if (e.target.classList.contains('menu-item__inputPlate')) {
                var _input = e.target.parentNode.parentNode.parentNode.querySelector('.menu-item__total');

                var _parentElem = e.target.parentElement.parentElement;
                updatePrice(e.target.value, 'plate', _parentElem.dataset.id, _input);
              }
            }); //Review Button

            reviewBtn = document.querySelector('.review-cta');
            reviewPrevBtn = document.querySelector('.review-prev');
            billCtaContainer = document.querySelector('.bill-container');
            billReviewContainer = document.querySelector('.bill-review-container');
            billReviewItems = document.querySelector('.bill-review-price-items');
            complimentItems = document.querySelector('.bill-compliment-items');
            reviewNextBtn = document.querySelector('.review-next');
            receiptContainer = document.querySelector('.bill-receipt-container');
            recieptPrevBtn = document.querySelector('.receipt-prev'); //Review Button
            ...
            billReviewItems.addEventListener('input', updateReviewPrice); //Complement Checks

            complimentItems.addEventListener('change', getCompliment); //Next button Review
  ...
  return function billInit() {
    return _ref.apply(this, arguments);
  };
}();

exports.billInit = billInit;
},{"./menuUtility":"menuUtility.js","./util":"util.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _printMenu = require("./printMenu");

var _billMenu = require("./billMenu");
...
if (usernameInput) {
  usernameInput.addEventListener('blur', function (e) {
    (0, _login.renderLoginInput)(usernameInput);
  });
}

if (passwordInput) {
  passwordInput.addEventListener('blur', function (e) {
    (0, _login.renderLoginInput)(passwordInput);
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.login)(usernameInput.value, passwordInput.value);
  });
} //****************************************************************** */
...
var updateAddBtn = document.getElementById('um-menu-add');

if (updateAddBtn) {
  updateAddBtn.addEventListener('click', function (e) {
    (0, _updateMenu.updateMenuModalDisplay)();
  });
} //Close Menu Modal


var updateModalClose = document.querySelector('.um-modal-form .btn-modal--cancel');
...
var updateModalSave = document.querySelector('.um-modal-form .btn-modal--save');

if (updateModalSave) {
  updateModalSave.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _updateMenu.addMenu)();
  });
} //Category Selection


var updateCategorySelect = document.getElementById('um-select');

if (updateCategorySelect) {
  updateCategorySelect.addEventListener('change', function (e) {
    (0, _updateMenu.updateMenuSelection)(updateCategorySelect.value);
  });
} //Update Menu Action and Input


var updateMenuContainer = document.querySelector('.um-menus');

if (updateMenuContainer) {
  updateMenuContainer.addEventListener('click', function (e) {
    (0, _updateMenu.updateMenuAction)(e);
  });
...
var printCategorySelection = document.getElementById('pm-select');

if (printCategorySelection) {
  printCategorySelection.addEventListener('change', function (e) {
    e.preventDefault();
    (0, _printMenu.renderMenu)(printCategorySelection.value);
  });
}

var btnPrint = document.querySelector('.pm-btn-print');

if (btnPrint) {
  btnPrint.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _printMenu.printMenu)();
  });
} //****************************************************************** */
//BILL MENU INTERFACE
//****************************************************************** */
